...
import net.bouzuya.blog.app.repository.request.parser.EntryDetailResponseParserImpl;
import net.bouzuya.blog.app.repository.request.parser.EntryListResponseParserImpl;
